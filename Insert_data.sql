...
(30,CONCAT('My Compositon__',floor(random() * (1000  ) + 1)::int::varchar(10)),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
(31,CONCAT('ComMypositon__',floor(random() * (1000  ) + 1)::int::varchar(10),' my'),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
(32,CONCAT('Compos my iton__',floor(random() * (1000  ) + 1)::int::varchar(10)),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
...
(35,CONCAT('Мой Compositon__',floor(random() * (1000  ) + 1)::int::varchar(10)),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
(36,CONCAT('Comp мой ositon__',floor(random() * (1000  ) + 1)::int::varchar(10)),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
(37,CONCAT('Compмойositon__',floor(random() * (1000  ) + 1)::int::varchar(10)),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
(38,CONCAT('Compositon__',floor(random() * (1000  ) + 1)::int::varchar(10),' мой'),floor(random() * (600 - 150 + 1) + 150)::int,floor(random() * (48  ) + 1)::int),
